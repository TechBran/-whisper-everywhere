...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = file("../whispereverywhere-release.jks")
            storePassword = "whisper2024release"
            keyAlias = "whispereverywhere"
            keyPassword = "whisper2024release"
        }
    }
