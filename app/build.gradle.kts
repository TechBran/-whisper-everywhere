...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 36
        versionCode = 96
        versionName = "4.7.0"  // THE Q8 LADDER. On 2026-09-17 five CPU rungs were timed on the owner's Tab S10+ against the same talk (docs/measurements/2026-09-17-tab-cpu-ladder.md) and the owner ruled the same day: "Q8 for everything" - "Q5 is definitely off the table". Small Q8_0 becomes the floor for every device and the default (the same weights as the 190 MB model, 2.2x faster per commit on that tablet), medium Q8_0 becomes the medium tier recommended above a provisional 5.5 GB RAM threshold, and large-v3-turbo Q8_0 stays an optional top rung - it kept up on a flagship with no margin, so it is offered for its accuracy and never advocated. The four Q5 rungs (the shipped 190 MB default among them) are retired the gentle way: hidden from the chooser, untouched for anyone who has one. PRODUCTION AUTHORISATION IS WITHHELD: the promotable set is empty pending the owner's accuracy pass on small and medium, so 96 goes to the internal track and a sideloaded tablet only. 95 was 4.6.0, the instrument ladder, never promoted.
