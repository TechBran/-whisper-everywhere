...
// Verbatim port of app/src/main/java/com/whispereverywhere/util/WerMath.kt (only the package line differs), so the
// probe scores its finals with EXACTLY the normalisation the app's benches use. Do not edit here; re-copy.
